...
#one-col-entry(content:[
  ...
  #v(design-highlights-top-margin);Alek G Erickson#sym.ast.basic#h(0pt, weak: true), #strong[#emph[Sergey Isaev]]#sym.ast.basic#h(0pt, weak: true), Jingyan He, et al.
...
#one-col-entry(content:[
  ...
  #v(-design-text-leading)
  #v(design-highlights-top-margin);Andrea J Radtke#sym.ast.basic#h(0pt, weak: true), Ekaterina Postovalova#sym.ast.basic#h(0pt, weak: true), Arina Varlamova, ..., #strong[#emph[Sergey Isaev]], et al.
